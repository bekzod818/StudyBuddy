...
from .views import home, room, create_room, update_room, delete_room, loginPage, logoutUser, registerPage, delete_message, userProfile, updateUser
...
urlpatterns = [
    ...
    path('update_message/', updateUser, name='update_user'),
]